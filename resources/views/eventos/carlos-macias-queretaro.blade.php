...
@section('description', 'Carlos Macias en Querétaro, 31 de agosto 2019, 21:00 hrs., Teatro del IMSS')

@section('styles')
<meta property="og:url"  content="https://www.bolematico.com/eventos/carlos-macias-queretaro" />
<meta property="og:title" content="Carlos Macias" />
<meta property="og:description" content="Carlos Macias, Queretaro 31 de agosto, Teatro del IMSS, 21:00 hrs boletos en bolematico.com" />
<meta property="og:image" content="https://www.bolematico.com/img/carlos-macias-queretaro.jpg" />
...
<div class="image-header bg-4 overlay overlay-5">
	...
	<div class="row white-text">
		...
		<p><i>31 de agosto - 21:00 hrs.</i></p>
	</div>
	...
	<div class="row">
		...
		<div id="descripcion" class="col s12 tab-content">
			...
			<div class="col s8 offset-s2 m4 offset-m1 mb-30">
				<img src="{{ asset('img/carlos-macias-queretaro.jpg') }}" alt="" class="responsive-img">
			</div>
		...
		<div class="col s12 m6">
			...
			<div class="col s12 center-align mt-15">
				...
				{!! Form::open(['route'=>'payment.details', 'method'=>'POST', 'id' => 'checkout-form', 'style' => 'display:none;']) !!}
					...
					{!! Form::hidden('img', 'img/carlos-macias-queretaro.jpg') !!}
					{!! Form::hidden('evento', 'Carlos Macias') !!}
					{!! Form::hidden('fecha', '31 de agosto 2019') !!}
					{!! Form::hidden('lugar', 'Teatro del IMSS') !!}
					{!! Form::hidden('ciudad', 'Querétaro') !!}
					{!! Form::hidden('hora', '21:00 hrs') !!}
					{!! Form::hidden('event_type', 'numerado') !!}
					{!! Form::hidden('impresion_boleto', true) !!}
					{!! Form::hidden('db_table', 'carlos_macias_qto_30ago') !!}
					{!! Form::hidden('info', '--') !!}
					{!! Form::hidden('select_type', 'manual') !!}
					{!! Form::hidden('url', url('eventos/carlos-macias-queretaro')) !!}
				{!! Form::close() !!}
			</div>
		</div>
...
@section('scripts')
	<script>
		var table = 'carlos_macias_qto_30ago';
		var base_path = '{{ url('/') }}';
		var precios = {'Diamante': 650, 'Oro': 450, 'Plata': 300};
