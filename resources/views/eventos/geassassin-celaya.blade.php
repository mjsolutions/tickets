...
@section('title', 'Geassassin - Celaya')

@section('description', 'Geassassin en Celaya, Salón West, 18 de octubre, 19:00 hrs boletos en bolematico.com')

@section('styles')
<meta property="og:url"  content="https://www.bolematico.com/eventos/geassassin-celaya" />
<meta property="og:title" content="Geassassin en Celaya" />
<meta property="og:description" content="Geassassin en Celaya, Salón West, 18 de octubre, 19:00 hrs boletos en bolematico.com" />
<meta property="og:image" content="https://www.bolematico.com/img/geassassin_celaya.jpg" />
...
<div class="image-header bg-4 overlay overlay-5">
	...
	<div class="row white-text">
		...
		<p class="mb-0"><i>Salón West - Celaya</i></p>
		<p class="m-0"><i>18 de octubre - 19:00 hrs.</i></p>
	</div>
	...
	<div class="row">
		...
		<div id="precios" class="col s12 tab-content" style="padding: 40px 0.75rem!important;">
			...
			<div class="col s8 offset-s2 m4 offset-m1 mb-30 card-flyer">
				<img src="{{ asset('img/geassassin_celaya.jpg') }}" alt="" class="responsive-img">
			</div>
			...
			<div class="col s12 m5 offset-m2">		
				...
				<div class="row center-align">
					...
					{!! Form::hidden('img', 'img/geassassin_celaya.jpg') !!}
					{!! Form::hidden('evento', 'Geassassin') !!}
					{!! Form::hidden('fecha', '18 de octubre 2020') !!}
					{!! Form::hidden('lugar', 'Salón West') !!}
					{!! Form::hidden('ciudad', 'Celaya, Gto.') !!}
					{!! Form::hidden('hora', '19:00 hrs') !!}
					{!! Form::hidden('event_type', 'general') !!}
					{!! Form::hidden('impresion_boleto', true) !!}
					{!! Form::hidden('db_table', 'geassassin_celaya_18oct') !!}
					{!! Form::hidden('info', '') !!}
					{!! Form::hidden('precio', '', ['id' => 'form_precio']) !!}
					{!! Form::hidden('url', url('eventos/geassassin-celaya')) !!}
		...
		{{-- <div id="lugares" class="col s12 tab-content">
				...
				<div class="white z-depth-2">
					...
					<div class=" p-30">
						...
						<ul class="qcAddress">
							...
							<li><i class="fa fa-map-marker"></i> <strong>DIRECCIÓN</strong>: <p>Calle de Eduardo Ruiz 620, Centro histórico de Celaya, 58000 Celaya, Mich.</p></li>
						</ul>
					</div>
				</div>
			...
			<div class="col s4">									
				<div class="white z-depth-2">
					...
					<div class=" p-30">
						...
						<ul class="qcAddress">
							<li><div class="divider"></div></li>
							<li><i class="fa fa-map-marker"></i> <strong>DIRECCIÓN</strong>: <p>20 de Noviembre 917, Centro Histórico, 58000 Celaya, Mich.</p></li>
			...
			<div class="col s4">									
				<div class="white z-depth-2">
					...
					<div class=" p-30">
						<h5><b>Salón West</b></h5>
						<ul class="qcAddress">
							<li><div class="divider"></div></li>
							<li><i class="fa fa-map-marker"></i> <strong>DIRECCIÓN</strong>: <p>Libramiento Oriente 3118, Jardines del Rincón, 58270 Celaya, Mich.</p></li>
						</ul>
					</div>
				</div>
...
<section id="compra" class="section-comprar">
	<div class="row">
		{{-- <h5 class="raleway center-align">Venta de boletos también en Taquillas de Salón West</h5> --}}
...
<section class="section-lugar">
	<div class="row">
		<div class="col m9">
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3736.1352414227035!2d-100.82237814905244!3d20.541646709535964!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x842cbabfaf65a8d1%3A0xb67473e38467ea60!2sSaloon%20West!5e0!3m2!1ses!2smx!4v1593400791029!5m2!1ses!2smx" width="100%" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
		</div>
		<div class="col m3">
			<h5 class="quote raleway">Lugar del evento</h5>
			
			<h5 class="mt-30">Salón West</h5>
			<div class="col s10">
				<div class="divider"></div>
			</div>
			<ul class="fa-ul" style="margin-top: 30px;">
				<li class="mb-10"><i class="fa-li fa fa-map-marker"></i>Av. Tecnológico #629 <br>Fovissste<br>Celaya, Gto.</li>
			</ul>
