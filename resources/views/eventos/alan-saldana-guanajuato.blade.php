...
@section('title', 'Alan Saldaña Valle de Santiago, Gto.')

@section('description', 'Alan Saldaña en Valle de Santiago, Gto., 01 de Febrero, 10 pm boletos en La Chismozza')
...
<div class="image-header bg-4 overlay overlay-5">
	...
	<div class="row white-text">
		...
		<p><i>Valle de Santiago, Gto. - La Chismozza</i></p>
	</div>
		...
		<div id="descripcion" class="col s12 tab-content">
			...
			<div class="col s12 m5 offset-m1">				
				...
				<div class="row">
					...
					<p class="center-align"><b>Informes:</b> <a href="tel:4561045309" style="background: #4caf50; color: #fff; padding: 5px 10px;"> 456 104 5309</a> / <a href="tel:4251741255" style="background: #4caf50; color: #fff; padding: 5px 10px;"> 425 174 1255</a></p>
				</div>
			</div>
		</div>
			...
			<div class="col s12">
				...
				<div class="col s12">									
					...
					<div class="white z-depth-2">
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3739.76870960488!2d-101.193542585603!3d20.39242411457309!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x842c8d094a24614d%3A0xaf4c4b34ab137f26!2sLa+Chismozza!5e0!3m2!1ses!2smx!4v1547395137246" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
					
					<!-- ## ADDRESS LIST ## -->
						<div class=" p-30">
							<h5><b>La Chismozza</b></h5>
							<ul class="qcAddress">
								<li><i class="medium material-icons">location_on</i><p><strong>DIRECCIÓN</strong>: Vicente Guerrero 31, Miravalle, 38400 Valle de Santiago, Gto.</p></li>
								<li><i class="medium material-icons">email</i><p><strong>EMAIL</strong>: No disponible</p></li>
								<li><i class="medium material-icons">language</i><p><strong>Website</strong>: <a title="website" href="https://www.facebook.com/LaChismozzaBarKaraoke/" target="_blank">https://www.facebook.com/LaChismozzaBarKaraoke/</a></p></li>
							</ul>
						</div>
					</div>
...
<section id="compra" class="section-comprar">
	...
	<div class="row mb-30">
		...
		<div class="col s12 m4 offset-m4">
			...
			{!! Form::hidden('lugar', 'La Chismozza') !!}
	...
	<div class="row">
		<h5 class="mt-50 center-align raleway">Boletos disponibles en el lugar del evento.</h5>
	</div>
...
@section('scripts')
	<script>
		...
		function initMap() {
		        var uluru = {lat: 20.3924241, lng: -101.1913526};
		        var map = new google.maps.Map(document.getElementById('map'), {
		          zoom: 17,
		          scrollwheel: false,
		          navigationControl: true,
		          draggable: true,
		          center: {lat: 20.3924241, lng: -101.1913526}
		        });
