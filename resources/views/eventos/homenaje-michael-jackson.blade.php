...
@section('title', 'Homenaje a Michael Jackson el Rey del Pop')

@section('description', 'Homenaje a Michael Jackson el Rey del Pop, Morelia 06 de marzo, 21:00 hrs boletos en RS Viajes Centro y bolematico.com')

@section('styles')
<meta property="og:url"  content="http://bolematico.mx/eventos/homenaje-michael-jackson" />
<meta property="og:title" content="Homenaje a Michael Jackson el Rey del Pop" />
<meta property="og:description" content="Homenaje a Michael Jackson el Rey del Pop, Morelia 06 de marzo, 21:00 hrs boletos en RS Viajes Centro y bolematico.com" />
<meta property="og:image" content="http://bolematico.mx/img/homenaje-michael-jackson.jpg" />
...
<div class="image-header bg-4 overlay overlay-5">
	...
	<div class="row white-text">
		<h4>Homenaje a Michael Jackson el Rey del Pop</h4>
		<div class="divider"></div>
		<p class="mb-0"><i>Teatro Morelos - Morelia</i></p>
		<p class="m-0"><i>06 de marzo, 21:00 hrs.</i></p>
	</div>
	...
	<div class="row">
		...
		<div id="descripcion" class="col s12 tab-content">
			...
			<div class="col s8 offset-s2 m3 offset-m1 mb-30 card-flyer">
				<img src="{{ asset('img/homenaje-michael-jackson.jpg') }}" alt="" class="responsive-img">
			</div>
		...
		<div id="biografia" class="col s12 tab-content">
			...
			<div class="col s8 offset-s2 hide-on-med-and-up">
				<img src="{{ asset('img/estefan-bio.jpg') }}" class="responsive-img">
			</div>
			<div class="col s12 m8 text-justify">
		        <p>Estefan Jackson el imitador numero 1  del Rey del Pop Michael Jackson en México y Latinoamerica, logra ser considerado uno de los 5 mejores imitadores del Rey del Pop a nivel mundial.</p>
		        <p>Con mas 20 años de trayectoria artistica ha sido merecedor de diferentes galardones por mencionar algunos de ellos:</p>
		        <ul>
		        	<li>La Cruz Roja México.</li>
		        	<li>La UNICEF a favor de los Niños con Cancer.</li>
		        	<li>El Microfono de Oro de la Asociación Nacional de Locutores.</li>
		        	<li>La revista Rolling Stone México, le entrega un reconocimiento por su gran trayectoria.</li>
		        	<li>Así mismo ha plasmado sus huellas en el paseo de la luminarias en México entre otros grandes reconocimientos.</li>
		        </ul>
		        <p>Ha colaborado con artistas como, Eugenio Derbez, Omar Chaparro, y con L.A.Park (La Parka Original) y en el cine a lado de Diego Luna, para la cinta Mister Lonely</p>
		        <p>Ha participado en los mejores programas de TV en México, en cadenas como Telemundo y Univisión en programas con Don Francisco en Sabado Gigante.</p>
		        <p>Ha llevado su espectáculo a Centro America, Estados Unidos, Canada, Asia y Europa.</p>
		        <p>Actualmente es autor del libro "El ombre en el espejo, una mirada dentro de ti , como lograr tus sueños".</p>
		        <p>Sin duda un gran artista, con una gran experiencia sobre el escenario, y un gran tributo a el rey del pop.</p>
...
<section class="section-video overlay overlay-5" style="background-image: url('https://img.youtube.com/vi/nt_FnM_i-Ew/hqdefault.jpg');">
	<div class="row center-align">
		<a class="white-text" id="modal-video-open" href="#modal-video" data-video="https://www.youtube.com/embed/nt_FnM_i-Ew"><i class="material-icons">play_circle_filled</i></a>
		<p class="white-text"><i>Estefan Jackson</i></p>
	</div>
</section>
		...
		<div class="col s12 m6">
			...
			<div class="col s12 center-align mt-15">
				...
				{!! Form::open(['route'=>'payment.details', 'method'=>'POST', 'id' => 'checkout-form', 'style' => 'display:none;']) !!}
					...
					{!! Form::hidden('img', 'img/homenaje-michael-jackson.jpg') !!}
					{!! Form::hidden('evento', 'Homenaje a Michael Jackson el Rey del Pop') !!}
					{!! Form::hidden('fecha', '06 de marzo 2019') !!}
					{!! Form::hidden('lugar', 'Teatro Morelos') !!}
					{!! Form::hidden('ciudad', 'Morelia') !!}
					{!! Form::hidden('hora', '21:00 hrs') !!}
					{!! Form::hidden('event_type', 'numerado') !!}
					{!! Form::hidden('impresion_boleto', true) !!}
					{!! Form::hidden('db_table', 'homenaje_mj_morelia_06mar') !!}
					{!! Form::hidden('info', '--') !!}
					{!! Form::hidden('select_type', 'manual') !!}
					{!! Form::hidden('url', url('eventos/homenaje-michael-jackson')) !!}
				{!! Form::close() !!}
			</div>
		</div>
...
@section('scripts')
	<script>
		var get_map_seat = '{{url('/api/getMapAsientos')}}/homenaje_mj_morelia_06mar';
		var base_path = '{{ url('/') }}';
