...
@section('title', 'Batalla de Campeones - Morelia')

@section('description', 'Batalla de Campeones en Morelia, Palacio del Arte, 29 de octubre, 21:00 hrs boletos en Rs Viajes Centro, Palacio del Arte, La Cueva de Chucho y bolematico.com')

@section('styles')
<meta property="og:url"  content="https://www.bolematico.com/eventos/batalla-de-campeones-morelia" />
<meta property="og:title" content="Batalla de Campeones en Morelia" />
<meta property="og:description" content="Batalla de Campeones en Morelia, Palacio del Arte, 29 de octubre, 21:00 hrs boletos en Rs Viajes Centro, Palacio del Arte, La Cueva de Chucho y bolematico.com" />
<meta property="og:image" content="https://www.bolematico.com/img/batalla-de-campeones-morelia.jpg" />
...
<div class="image-header bg-4 overlay overlay-5">
	...
	<div class="row white-text">
		<h4>Batalla de Campeones</h4>
		<div class="divider"></div>
		<p class="mb-0"><i>Palacio del Arte - Morelia</i></p>
		<p class="m-0"><i>29 de octubre - 21:00 hrs.</i></p>
	</div>
	...
	<div class="row">
		...
		<div id="precios" class="col s12 tab-content" style="padding: 40px 0.75rem!important;">
			...
			<div class="col s8 offset-s2 m4 offset-m1 mb-30 card-flyer">
				<img src="{{ asset('img/batalla-de-campeones-morelia.jpg') }}" alt="" class="responsive-img">
			</div>
			...
			<div class="col s12 m5 offset-m2">		
				...
				<div class="row">
					...
					<div class="qcPricing col s12 center-align mb-10">
						<div class="box col s12">
							<header>
								<div class="col s12 teal accent-4">Oro</div>
							</header>
							<div class="price col s12"><span>$630</span> MXN</div>
						</div>
					</div>
				...
				<div class="row center-align">
					...
					{!! Form::hidden('img', 'img/batalla-de-campeones-morelia.jpg') !!}
					{!! Form::hidden('evento', 'Batalla de Campeones') !!}
					{!! Form::hidden('fecha', '29 de octubre 2020') !!}
					{!! Form::hidden('lugar', 'Palacio del Arte') !!}
					{!! Form::hidden('ciudad', 'Morelia, Mich.') !!}
					{!! Form::hidden('hora', '21:00 hrs') !!}
					{!! Form::hidden('event_type', 'general') !!}
					{!! Form::hidden('impresion_boleto', true) !!}
					{!! Form::hidden('db_table', 'batalla_campeones_morelia_19mar') !!}
					{!! Form::hidden('info', '') !!}
					{!! Form::hidden('precio', '', ['id' => 'form_precio']) !!}
					{!! Form::hidden('url', url('eventos/batalla-de-campeones-morelia')) !!}
...
<section class="section-video overlay overlay-5" style="background-image: url('https://img.youtube.com/vi/SAkElf121kE/maxresdefault.jpg');">
	<div class="row center-align">
		<a class="white-text" id="modal-video-open" href="#modal-video" data-video="https://www.youtube.com/embed/SAkElf121kE"><i class="material-icons">play_circle_filled</i></a>
		<p class="white-text"><i>ACZINO VS EL H/4TOS/BATALLA DE CAMPEONES/AFTER VISION/FREESTYLE RAP/MEXICO VS COLOMBIA</i></p>
	</div>
</section>

<section id="compra" class="section-comprar">
	<div class="row">
		{{-- <h5 class="raleway center-align">Venta de boletos también en Taquillas de Palacio del Arte</h5> --}}
...
@section('scripts')
	<script>
		var precios = {'Oro+M&G':1030, 'Oro': 630, 'General': 380};
