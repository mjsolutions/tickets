...
@section('title', 'Paté de Fua Querétaro')

@section('description', 'Paté de Fua en Querétaro, 15 de noviembre, 9:00 pm boletos en bolematico.mx y La Glotonería Querétaro')

@section('styles')

<!-- Metas Facebook -->
<meta property="og:url"  content="http://bolematico.mx/eventos/pate-de-fua-queretaro" />
<meta property="og:title" content="Paté de Fua en Querétaro" />
<meta property="og:description" content="Regresa Paté de Fua en Querétaro, 15 de noviembre, 9:00 pm, La Glotonería" />
<meta property="og:image" content="http://bolematico.mx/img/pate-de-fua-queretaro.jpg" />
...
<div class="image-header bg-4 overlay overlay-5">
	...
	<div class="row white-text">
		...
		<p><i>Querétaro - La Glotonería 15 de noviembre, 21 hrs.</i></p>
	</div>
	...
	<div class="row">
		...
		<div id="descripcion" class="col s12 tab-content">
			...
			<div class="col s8 offset-s2 m4 offset-m1 mb-30">
				<img src="{{ asset('img/pate-queretaro.jpg') }}" alt="" class="responsive-img">
			</div>
			...
			<div class="col s12">
				...
				<div class="col s12">									
					...
					<div class="white z-depth-2">
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3732.9792147672038!2d-100.43527658559849!3d20.670424605291423!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85d35a05c27b2d07%3A0x74cd9fef17e4d008!2sLa+Glotoner%C3%ADa!5e0!3m2!1ses!2smx!4v1540681451507" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
					
					<!-- ## ADDRESS LIST ## -->
						<div class=" p-30">
							<h5><b>La Glotonería</b></h5>
							<ul class="qcAddress">
								<li><div class="divider"></div></li>
								<li><i class="fa fa-map-marker"></i> <strong>DIRECCIÓN</strong>: <p>Salitre, 76230 Santiago de Querétaro, Qro.</p></li>
								<li><i class="fa fa-phone"></i> <strong>TELÉFONO</strong>: <p> --</p></li>
								<li><i class="fa fa-calendar"></i> <strong>HORARIO</strong>: <p>--</p></li>
								<li><i class="fa fa-globe"></i> <strong>Website</strong>: <p><a title="website" href="https://www.facebook.com/LaglotoneriaFoodpark/" target="_blank">https://www.facebook.com/LaglotoneriaFoodpark/</a></p></li>
							</ul>
						</div>
					</div>
...
<section id="compra" class="section-comprar">
	...
	<div class="row mb-30">
		...
		<div class="col s12 m4 offset-m4">
			...
			{!! Form::hidden('db_table', 'pate_de_fua_queretaro_15nov') !!}
			{!! Form::hidden('info', 'Favor de comunicarte al numero 442 218 4200 para reservar tu lugar.') !!}
			{!! Form::hidden('precio', '450') !!}
			{!! Form::hidden('url', url('eventos/pate-de-fua-queretaro')) !!}
...
<section class="section-lugar">
	...
	<div class="info-lugar">
		...
		<p><b>La Glotonería</b></p>
		<p><i class="material-icons">location_on</i>Salitre, 76230 Santiago de Querétaro, Qro.</p>
		<p><i class="material-icons">call</i> --</p>
		<p><i class="material-icons">email</i> --</p>
		<p><i class="material-icons">language</i> <a title="website" href="https://www.facebook.com/LaglotoneriaFoodpark/" target="_blank">https://www.facebook.com/LaglotoneriaFoodpark/</a></p>
	</div>
</section>
...
@section('scripts')
	<script>
		...
		function initMap() {
		        var uluru = {lat: 20.6704246, lng: -100.4330766};
		        var map = new google.maps.Map(document.getElementById('map'), {
		          zoom: 17,
		          scrollwheel: false,
		          navigationControl: true,
		          draggable: true,
		          center: {lat: 20.6704246, lng: -100.4330766}
		        });
