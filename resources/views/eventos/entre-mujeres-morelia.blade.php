...
@section('description', 'Entre Mujeres, Morelia 09 de abril, Teatro Morelos, 19:00 hrs boletos en RS Viajes Centro, taquillas del planetario y bolematico.com')

@section('styles')
<meta property="og:url"  content="http://bolematico.mx/eventos/entre-mujeres-morelia" />
<meta property="og:title" content="Entre Mujeres" />
<meta property="og:description" content="Entre Mujeres, Morelia 09 de mayo, Teatro Morelos, 19:00 hrs boletos en RS Viajes Centro, taquillas del planetario y bolematico.com" />
...
<div class="image-header bg-4 overlay overlay-5">
	...
	<div class="row white-text">
		...
		<p class="m-0"><i>09 de mayo - 19:00 hrs.</i></p>
	</div>
		...
		<div class="col s12 m6">
			...
			<div class="col s12 center-align mt-15">
				...
				{!! Form::open(['route'=>'payment.details', 'method'=>'POST', 'id' => 'checkout-form', 'style' => 'display:none;']) !!}
					...
					{!! Form::hidden('db_table', 'entre_mujeres_morelia_09may_19hr') !!}
					{!! Form::hidden('info', '--') !!}
					{!! Form::hidden('select_type', 'manual') !!}
					{!! Form::hidden('url', url('eventos/entre-mujeres-morelia')) !!}
				{!! Form::close() !!}
			</div>
		</div>
...
@section('scripts')
	<script>
		var table = "entre_mujeres_morelia_09may_19hr";
		var base_path = '{{ url('/') }}';
