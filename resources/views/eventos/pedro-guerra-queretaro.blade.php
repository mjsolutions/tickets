...
@section('title', 'Pedro Guerra - Querétaro')

@section('description', 'Pedro Guerra en Querétaro, El Portón de Santiago, 01 de marzo, 19:00 hrs boletos en El Portón de Santiago y bolematico.com')

@section('styles')
<meta property="og:url"  content="https://www.bolematico.com/eventos/pedro-guerra-queretaro" />
<meta property="og:title" content="Pedro Guerra en Querétaro" />
<meta property="og:description" content="Pedro Guerra en Querétaro, El Portón de Santiago, 01 de marzo, 19:00 hrs boletos en El Portón de Santiago y bolematico.com" />
<meta property="og:image" content="https://www.bolematico.com/img/pedro-guerra-queretaro.jpg" />
...
@php
	$preventa = false;
	if(\Carbon\Carbon::now() < '2020-02-19 23:59:59'){
		$preventa = true;
	}
@endphp
...
<div class="image-header bg-del-olmo overlay overlay-5">
	...
	<div class="row white-text">
		...
		<p class="m-0"><i>01 de marzo - 19:00 hrs.</i></p>
	</div>
	...
	<div class="row">
		...
		<div id="precios" class="col s12 tab-content" style="padding: 40px 0.75rem!important;">
			...
			<div class="col s8 offset-s2 m4 offset-m1 mb-30 card-flyer">
				<img src="{{ asset('img/pedro-guerra-queretaro.jpg') }}" alt="" class="responsive-img">
			</div>
			...
			<div class="col s12 m5 offset-m2">				
				...
				<div class="row center-align">
					...
					{!! Form::hidden('img', 'img/pedro-guerra-queretaro.jpg') !!}
					{!! Form::hidden('evento', 'Pedro Guerra') !!}
					{!! Form::hidden('fecha', '01 de marzo 2020') !!}
					...
					{!! Form::hidden('db_table', 'pedro_guerra_qto_27feb') !!}
					...
					@endif
					{!! Form::hidden('url', url('eventos/pedro-guerra-queretaro')) !!}
