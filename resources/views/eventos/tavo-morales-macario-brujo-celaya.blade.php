...
@section('description', 'Tavo Morales y Macario Brujo, Celaya 17 de julio, BLVD 804, 21:00 hrs boletos en BLVD 804 y bolematico.com')

@section('styles')
<meta property="og:url"  content="https://www.bolematico.com/eventos/tavo-morales-macario-brujo-celaya" />
<meta property="og:title" content="Tavo Morales y Macario Brujo" />
<meta property="og:description" content="Tavo Morales y Macario Brujo, Celaya 17 de julio, BLVD 804, 21:00 hrs boletos en BLVD 804 y bolematico.com" />
<meta property="og:image" content="https://www.bolematico.com/img/tavo-macario-celaya.jpg" />
...
<div class="image-header bg-4 overlay overlay-5">
	...
	<div class="row white-text">
		...
		<p class="m-0"><i>17 de julio - 21:00 hrs.</i></p>
	</div>
	...
	<div class="row">
		...
		<div id="precios" class="col s12 tab-content">
			...
			<div class="col s10 offset-s1 m4 offset-m1 mb-30 card-flyer">
				<img src="{{ asset('img/tavo-macario-celaya.jpg') }}" alt="" class="responsive-img">
			</div>
...
<section id="compra" class="section-comprar">
	...
	<div class="col s12 m4 offset-m4">
		...
		{!! Form::open(['route' => 'payment.details', 'method' => 'POST', 'id' => 'paymentForm'])!!}
			...
			{!! Form::hidden('img', 'img/tavo-macario-celaya.jpg') !!}
			{!! Form::hidden('evento', 'Tavo Morales y Macario Brujo') !!}
			{!! Form::hidden('fecha', '17 de julio 2019') !!}
