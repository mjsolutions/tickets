...
@section('title', 'Edgar Oceransky Xalapa')

@section('description', 'Edgar Oceransky en Xalapa Veracruz, 18 de Mayo, 10:30 pm boletos en Xcape Xalapa')
	...
	<div class="row">
		...
		<div id="descripcion" class="col s12 tab-content">
			<div class="col s8 offset-s2 m3 mb-30">
				<img src="{{ asset('img/oceransky-xalapa.jpg') }}" alt="Edgar oceransky Xalapa" class="responsive-img">
			</div>
			...
			<div class="row">
				...
				<div class="col s12 m6">									
					...
					<div class="qcEventlayout">
						<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15041.485705801893!2d-96.8993532!3d19.5256611!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x7ad07437bc6ac55b!2sXcape!5e0!3m2!1ses!2smx!4v1493423069633" width="100%" height="320" frameborder="0" style="border:0" allowfullscreen></iframe>
					</div>
				...
				<div class="col s12 m6">
					<ul class="qcAddress">
						<li><i class="medium material-icons">location_on</i><p><strong>DIRECCIÓN</strong>: Avenida 20 de Noviembre 635, Colonia Badillo, 91190 Xalapa Enríquez, Ver.</p></li>
						<li><i class="medium material-icons">call</i><p><strong>TELÉFONO</strong>: 01 228 124 2720</p></li>
						<li><i class="medium material-icons">email</i><p><strong>EMAIL</strong>: No disponible</p></li>
						<li><i class="medium material-icons">language</i><p><strong>Website</strong>: <a title="website" href="https://www.facebook.com/XCAPE-Xalapa-474340082664705/" target="_blank">https://www.facebook.com/XCAPE-Xalapa-474340082664705</a></p></li>
					</ul>
				</div>
			</div>
...
<section class="section-lugar">
	...
	<div class="info-lugar">
		...
		<p><i class="material-icons">location_on</i> Avenida 20 de Noviembre 635, Colonia Badillo, 91190 Xalapa Enríquez, Ver.</p>
		<p><i class="material-icons">call</i> 01 228 124 2720</p>
		<p><i class="material-icons">email</i> No disponible</p>
		<p><i class="material-icons">language</i> <a title="website" href="https://www.facebook.com/XCAPE-Xalapa-474340082664705/" target="_blank">https://www.facebook.com/XCAPE-Xalapa-474340082664705</a></p>
	</div>
</section>
...
@section('scripts')
	<script>
		...
		function initMap() {
		        var uluru = {lat: 19.5256611, lng: -96.8993532};
		        var map = new google.maps.Map(document.getElementById('map'), {
		          zoom: 19,
		          scrollwheel: false,
		          navigationControl: true,
		          draggable: true,
		          center: {lat: 19.5256611, lng: -96.8993532}
		        });
