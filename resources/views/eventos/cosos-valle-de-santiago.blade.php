...
@section('title', 'Cosos Cañon Valle de Santiago, Gto.')

@section('description', 'Cosos Cañon en Valle de Santiago, Gto., 16 de marzo 2019, 21:00 hrs La Chismozza')
	...
	<div class="row">
		...
		<div id="descripcion" class="col s12 tab-content">
			...
			<div class="col s8 offset-s2 m4 offset-m1 mb-30">
				<img src="{{ asset('img/cosos-valle.jpg') }}" alt="" class="responsive-img">
			</div>
		...
		<div id="lugares" class="col s12 tab-content">
			...
			<div class="col s12">									
				...
				<div class="white z-depth-2">
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d10692.296325186377!2d-91.81301516629037!3d18.650635999754062!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x8aeb18cc66d128a!2sLa Chismozza Bar+Cd.+Del+Carmen!5e0!3m2!1ses!2smx!4v1520410804789" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
...
<section id="compra" class="section-comprar">
	...
	<div class="row mb-30">
		...
		<div class="col s12 m4 offset-m4">
			...
			{!! Form::hidden('img', 'img/cosos-valle.jpg') !!}
			{!! Form::hidden('evento', 'Cosos Cañon') !!}
			{!! Form::hidden('fecha', '16 de marzo 2019') !!}
