...
@section('description', 'Slobotzky y Ricardo Pérez, Querétaro 08 de junio, El Portón de Santiago, 21:30 hrs boletos en El Portón de Santiago y bolematico.com')

@section('styles')
<meta property="og:url"  content="http://bolematico.mx/eventos/slobotzky-y-ricardo-perez-queretaro" />
<meta property="og:title" content="Slobotzky y Ricardo Pérez" />
<meta property="og:description" content="Slobotzky y Ricardo Pérez, Querétaro 08 de junio, El Portón de Santiago, 21:30 hrs boletos en El Portón de Santiago y bolematico.com" />
<meta property="og:image" content="http://bolematico.mx/img/syr-queretaro.jpg" />
...
<div class="image-header bg-4 overlay overlay-5">
	...
	<div class="row white-text">
		...
		<p class="m-0"><i>08 de junio - 21:30 hrs.</i></p>
	</div>
	...
	<div class="row">
		...
		<div id="precios" class="col s12 tab-content">
			...
			<div class="col s8 offset-s2 m8 offset-m2 mb-30 card-flyer">
				<img src="{{ asset('img/syr-queretaro-banner.jpg') }}" alt="" class="responsive-img">
			</div>
...
<section id="compra" class="section-comprar">
	...
	<div class="col s12 m4 offset-m4">
		...
		{!! Form::hidden('fecha', '08 de junio 2019') !!}
		...
		{!! Form::hidden('db_table', 'syr_queretaro_08jun') !!}
