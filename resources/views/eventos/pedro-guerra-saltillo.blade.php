...
@section('title', 'Pedro Guerra - Saltillo')

@section('description', 'Pedro Guerra en Saltillo, Rincón Santa Lucia, 06 de marzo, 21:00 hrs boletos en Rincón Santa Lucia y bolematico.com')

@section('styles')
<meta property="og:url"  content="https://www.bolematico.com/eventos/pedro-guerra-saltillo" />
<meta property="og:title" content="Pedro Guerra en Saltillo" />
<meta property="og:description" content="Pedro Guerra en Saltillo, Rincón Santa Lucia, 06 de marzo, 21:00 hrs boletos en Rincón Santa Lucia y bolematico.com" />
<meta property="og:image" content="https://www.bolematico.com/img/pedro-guerra-saltillo.jpg" />
...
@php
	$preventa = false;
	if(\Carbon\Carbon::now() < '2020-02-27 23:59:59'){
		$preventa = true;
	}
@endphp
...
<div class="image-header bg-del-olmo overlay overlay-5">
	...
	<div class="row white-text">
		...
		<p class="mb-0"><i>Rincón Santa Lucia - Saltillo</i></p>
	...
	<div class="row">
		...
		<div id="precios" class="col s12 tab-content" style="padding: 40px 0.75rem!important;">
			...
			<div class="col s8 offset-s2 m4 offset-m1 mb-30 card-flyer">
				<img src="{{ asset('img/pedro-guerra-saltillo.jpg') }}" alt="" class="responsive-img">
			</div>
			...
			<div class="col s12 m5 offset-m2">				
				...
				<div class="row center-align">
					...
					{!! Form::hidden('img', 'img/pedro-guerra-saltillo.jpg') !!}
					{!! Form::hidden('evento', 'Pedro Guerra') !!}
					{!! Form::hidden('fecha', '06 de marzo 2020') !!}
					{!! Form::hidden('lugar', 'Rincón Santa Lucia') !!}
					{!! Form::hidden('ciudad', 'Saltillo') !!}
					...
					{!! Form::hidden('db_table', 'pedro_guerra_saltillo_06mar') !!}
					{!! Form::hidden('info', 'Favor de comunicarte al numero 8441017417 para completar tu reservación.') !!}
					@if($preventa)
					{!! Form::hidden('precio', 480) !!}
					@else
					{!! Form::hidden('precio', 580) !!}
					@endif
					{!! Form::hidden('url', url('eventos/pedro-guerra-saltillo')) !!}
          ...
          <p> * Informes y confirmación de tu reservación (una vez realizada tu compra) <br> <a href="tel:8441017417" style="background: #4caf50; color: #fff; padding: 5px 10px;">844-101-7417</a></p>
		...
		<div id="lugares" class="col s12 tab-content">
			...
			<div class="col s12">									
				<div class="white z-depth-2">
					<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14408.333533434723!2d-100.9777861942261!3d25.46889102407523!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x43b4e7749db9f364!2sRincon%20Santa%20Lucia%20Pe%C3%B1a%20Latina!5e0!3m2!1ses!2smx!4v1580770614016!5m2!1ses!2smx" width="100%" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe>

					<div class=" p-30">
						<h5 class="raleway"><b>Rincón Santa Lucia</b></h5>
						<ul class="qcAddress">
							<li><div class="divider"></div></li>
							<li><i class="fa fa-map-marker"></i> <p> Blvd. Pedro Figueroa 745, Real de Peña, 25256 Saltillo, Coah.</p></li>
							<li><i class="fa fa-phone"></i><p> 844 416 8592</p></li>
							<li><i class="fa fa-facebook-official"></i><p><a title="website" href="https://www.facebook.com/RinconSantaLucia" target="_blank">https://www.facebook.com/RinconSantaLucia</a></p></li>
						</ul>
					</div>
				</div>
...
<section id="compra" class="section-comprar">
	<div class="row">
		<h5 class="raleway center-align">Venta de boletos también en Rincón Santa Lucia</h5>
...
<section class="section-lugar">
	<div class="row">
		...
		<div class="col m3">
			...
			<h5 class="mt-30">Rincón Santa Lucia</h5>
			<div class="col s10">
				<div class="divider"></div>
			</div>
			<ul class="fa-ul" style="margin-top: 30px;">
				<li class="mb-10"><i class="fa-li fa fa-map-marker"></i>Blvd. Pedro Figueroa 745, <br>Real de Peña, 25256 <br>Saltillo, Coah.</li>
			</ul>
