...
@section('title', 'Martin Valverde Aguascalientes')

@section('description', 'Martin Valverde en Aguascalientes, 30 de Noviembre, 9:00 pm boletos en Auditorio DIMO y en bolematico.mx')
	...
	<div class="row">
		...
		<div id="descripcion" class="col s12 tab-content">
			...
			<div class="col s8 offset-s2 m3 mb-30 card-flyer">
				<img src="{{ asset('img/martin-valverde.jpg') }}" alt="" class="responsive-img">
			</div>
				...
				<div class="row">
					...
					<div class="qcPricing col s12 center-align mb-10">
						<div class="box col s12">
							...
							<div class="price col s12"><span>$370</span> Por entrada</div>
					...
					<div class="qcPricing col s12 center-align mb-10">
						<div class="box col s12">
							<header>
								<div class="col s12 m8 purple lighten-1">Diamante</div>
								<div class="col m4 btn-buy nopadding hide-on-small-only"><a href="#compra" class="page-scroll"><b>Comprar</b> <i class="fa fa-ticket" aria-hidden="true"></i></a></div>
							</header>
							<div class="price col s12"><span>$340</span> Por entrada</div>
							<div class="col s12 btn-buy nopadding hide-on-med-and-up"><a href="#compra" class="page-scroll"><b>Comprar</b> <i class="fa fa-ticket" aria-hidden="true"></i></a></div>
						</div>
					</div>
					...
					<div class="qcPricing col s12 center-align mb-10">
						<div class="box col s12">
							...
							<div class="price col s12"><span>$310</span> Por entrada</div>
							<div class="col s12 btn-buy nopadding hide-on-med-and-up"><a href="#compra" class="page-scroll"><b>Comprar</b> <i class="fa fa-ticket" aria-hidden="true"></i></a></div>
						</div>
					</div>
					...
					<div class="qcPricing col s12 center-align mb-10">
						<div class="box col s12">
							<header>
								<div class="col s12 m8 green lighten-1">Bronce</div>
								<div class="col m4 btn-buy nopadding hide-on-small-only"><a href="#compra" class="page-scroll"><b>Comprar</b> <i class="fa fa-ticket" aria-hidden="true"></i></a></div>
							</header>
							<div class="price col s12"><span>$190</span> Por entrada</div>
							<div class="col s12 btn-buy nopadding hide-on-med-and-up"><a href="#compra" class="page-scroll"><b>Comprar</b> <i class="fa fa-ticket" aria-hidden="true"></i></a></div>
						</div>
					</div>
		...
		<div id="biografia" class="col s12 tab-content">
			<div class="col s8 offset-s2 hide-on-med-and-up">
				<img src="{{ asset('img/martin-valverde-bio.jpg') }}" class="responsive-img">
			</div>
			<div class="col s12 m7">
				<h4 class="mt-0 raleway quote">BIOGRAFIA</h4>		
		         <p>Nació en San José, Costa Rica el 19 de enero de 1963.  Realizó sus estudios en el Colegio Salesiano Don Bosco, con quienes estudió y compartió por once años. Sus formadores más importantes en ese tiempo fueron los sacerdotes y maestros de dicha congregación, quienes le infundieron su amor y visión por los jóvenes, por Dios, por la Iglesia, por María y por la música y el arte.</p>
		         <p>Con su música y sus conciertos ha estado en casi toda América Latina incluida Brasil, Estados Unidos, Canadá, Rusia, Israel, y en  parte de Europa. Aunando a esto producciones en Portugués, Italiano, Inglés y por supuesto, en español.</p>
		         <p>Actualmente dirige una empresa de laicos católicos, que fundó en 1991 junto con su esposa, llamada Producciones Dynamis. Esta produce, organiza y distribuye sus producciones musicales, eventos, y su material en general por todo el mundo.</p>
		         <p>Hoy en día, Martín continúa siendo uno de los principales comunicadores de la Buena Nueva, haciéndolo con fe, humor, música y reflexión, a través de la música contemporánea con alta calidad.</p>
		         <p><small>Fuente: http://martinvalverde.com/bio/</small></p>
			...
			<div class="row">
				...
				<div class="col s12 m6">
					<ul class="qcAddress">
						...
						<li><i class="medium material-icons">call</i><p><strong>TELÉFONO</strong>: 449 915 7353</p></li>
...
<section class="section-video overlay overlay-5" style="background-image: url('https://img.youtube.com/vi/sjZHmzEMqqY/maxresdefault.jpg');">
	<div class="row center-align">
		<a class="white-text" id="modal-video-open" href="#modal-video" data-video="https://www.youtube.com/embed/sjZHmzEMqqY"><i class="material-icons">play_circle_filled</i></a>
		<p class="white-text"><i>Martin Valverde - ¿A Qué Esperar?</i></p>
	</div>
</section>
