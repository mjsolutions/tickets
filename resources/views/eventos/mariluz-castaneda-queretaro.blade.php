...
@section('title', 'Mariluz Castañeda')

@section('description', 'Mariluz Castañeda, con Poncho Moreleón y Carlos Maciel, invitados especiales, Querétaro 04 de julio, El Portón de Santiago, 21:00 hrs boletos en El Portón de Santiago y bolematico.com')

@section('styles')
<meta property="og:url"  content="https://www.bolematico.com/eventos/mariluz-castaneda-queretaro" />
<meta property="og:title" content="Mariluz Castañeda" />
<meta property="og:description" content="Mariluz Castañeda, con Poncho Moreleón y Carlos Maciel, invitados especiales, Querétaro 04 de julio, El Portón de Santiago, 21:00 hrs boletos en El Portón de Santiago y bolematico.com" />
<meta property="og:image" content="https://www.bolematico.com/img/mariluz-queretaro.jpg" />
...
<div class="image-header bg-4 overlay overlay-5">
	...
	<div class="row white-text">
		<h4>Mariluz Castañeda</h4>
		<div class="divider"></div>
		<p class="mb-0"><i>El Portón de Santiago - Querétaro</i></p>
		<p class="m-0"><i>04 de julio - 21:00 hrs.</i></p>
	</div>
	...
	<div class="row">
		...
		<div id="precios" class="col s12 tab-content">
			...
			<div class="col s10 offset-s1 m4 offset-m1 mb-30 card-flyer">
				<img src="{{ asset('img/mariluz-queretaro.jpg') }}" alt="" class="responsive-img">
			</div>
...
<section class="section-video overlay overlay-5" style="background-image: url('https://img.youtube.com/vi/w7eW-Lb9r7w/maxresdefault.jpg');">
	<div class="row center-align">
		<a class="white-text" id="modal-video-open" href="#modal-video" data-video="https://www.youtube.com/embed/w7eW-Lb9r7w"><i class="material-icons">play_circle_filled</i></a>
		<p class="white-text"><i>Mariluz Castañeda</i></p>
	</div>
</section>
...
<section id="compra" class="section-comprar">
	...
	<div class="col s12 m4 offset-m4">
		...
		{!! Form::open(['route' => 'payment.details', 'method' => 'POST', 'id' => 'paymentForm'])!!}
			...
			{!! Form::hidden('img', 'img/mariluz-queretaro.jpg') !!}
			{!! Form::hidden('evento', 'Mariluz Castañeda') !!}
