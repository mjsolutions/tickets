...
@section('title', 'Gon Curiel Mazatlán')

@section('description', 'Gon Curiel en Mazatlán, 28 de febrero 2019, 19:00 hrs preventa $280, evento $310')
...
<div class="image-header bg-4 overlay overlay-5">
	...
	<div class="row white-text">
		...
		<p><i>Mazatlán - Tarros Company</i></p>
	</div>
	...
	<div class="row">
		...
		<div id="descripcion" class="col s12 tab-content">
			...
			<div class="col s8 offset-s2 m4 offset-m1 mb-30">
				<img src="{{ asset('img/gon-mazatlan.jpg') }}" alt="" class="responsive-img">
			</div>
		...
		<div id="lugares" class="col s12 tab-content">
			...
			<div class="col s12">									
				...
				<div class="white z-depth-2">
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3665.504567448793!2d-106.46663103555336!3d23.261109013209055!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8698ab35535841c9%3A0xcbf2572028024587!2sTarros+Company%2C+Av+Camar%C3%B3n+S%C3%A1balo%2C+S%C3%A1balo+Country%2C+82100+Mazatl%C3%A1n%2C+Sin.!5e0!3m2!1ses!2smx!4v1548116217483" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
				
				<!-- ## ADDRESS LIST ## -->
					<div class=" p-30">
						<h5 class="raleway"><b>Tarros Company</b></h5>
						<ul class="qcAddress">
							<li><div class="divider"></div></li>
							<li><i class="fa fa-map-marker"></i> <p>Av Camarón Sábalo Sábalo Country 82100 Mazatlán, Sin.</p></li>
							<li><i class="fa fa-phone"></i><p> 669 240 7103</p></li>
							<li><i class="fa fa-facebook-official"></i><p><a title="website" href="https://www.facebook.com/TarrosCo/" target="_blank">https://www.facebook.com/TarrosCo/</a></p></li>
						</ul>
					</div>
				</div>
...
<section class="section-lugar">
	...
	<div class="info-lugar">
		...
		<p><b>Tarros Company</b></p>
		<p><i class="material-icons">location_on</i>Av Camarón Sábalo Sábalo Country 82100 Mazatlán, Sin.</p>
		<p><i class="material-icons">call</i> 669 240 7103</p>
		<p><i class="fa fa-facebook-official"></i> https://www.facebook.com/TarrosCo/</p>
	</div>
</section>
...
@section('scripts')
	<script>
		...
		function initMap() {
		        var uluru = {lat: 23.2610737, lng: -106.4645087};
		        var map = new google.maps.Map(document.getElementById('map'), {
		          zoom: 17,
		          scrollwheel: false,
		          navigationControl: true,
		          draggable: true,
		          center: {lat: 23.2610737, lng: -106.4632087}
		        });
