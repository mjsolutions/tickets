...
@section('title', 'Peces de Ciudad')

@section('description', 'Peces de Ciudad, Querétaro 02 de agosto, El Portón de Santiago, 21:30 hrs boletos en El Portón de Santiago y bolematico.com')

@section('styles')
<meta property="og:url"  content="https://www.bolematico.com/eventos/peces-de-ciudad-queretaro" />
<meta property="og:title" content="Peces de Ciudad" />
<meta property="og:description" content="Peces de Ciudad, Querétaro 02 de agosto, El Portón de Santiago, 21:30 hrs boletos en El Portón de Santiago y bolematico.com" />
<meta property="og:image" content="https://www.bolematico.com/img/peces-ciudad-queretaro.jpg" />
...
<div class="image-header bg-4 overlay overlay-5">
	...
	<div class="row white-text">
		<h4>Peces de Ciudad <br><small>Cantando a Joaquín Sabina</small></h4>
	...
	<div class="row">
		...
		<div id="precios" class="col s12 tab-content">
			...
			<div class="col s10 offset-s1 m4 offset-m1 mb-30 card-flyer">
				<img src="{{ asset('img/peces-ciudad-queretaro.jpg') }}" alt="" class="responsive-img">
			</div>
...
{{-- <section class="section-video overlay overlay-5" style="background-image: url('https://img.youtube.com/vi/FJDAfJiJQEs/hqdefault.jpg');">
	<div class="row center-align">
		...
		<p class="white-text"><i>Peces de Ciudad </i></p>
	</div>
</section> --}}
...
<section id="compra" class="section-comprar">
	...
	<div class="col s12 m4 offset-m4">
		...
		{!! Form::open(['route' => 'payment.details', 'method' => 'POST', 'id' => 'paymentForm'])!!}
			...
			{!! Form::hidden('img', 'img/peces-ciudad-queretaro.jpg') !!}
			{!! Form::hidden('evento', 'Peces de Ciudad') !!}
