...
@section('description', 'Las Aventuras de..., Teatro Obrero, Zamora Mich., 21 de marzo, 16:00 hrs')

@section('styles')
<meta property="og:url"  content="https://www.bolematico.com/eventos/las-aventuras-de-16hrs" />
<meta property="og:title" content="Las Aventuras de..." />
<meta property="og:description" content="Las Aventuras de..., Teatro Obrero, Zamora Mich., 21 de marzo, 16:00 hrs" />
...
<div class="image-header bg-4 overlay overlay-5">
	...
	<div class="row white-text">
		...
		<p class="m-0"><i>21 de marzo - 16:00 hrs.</i></p>
	</div>
		...
		<div id="precios" class="col s12 tab-content">
			...
			<div class="col s12 m5 offset-m2">				
				...
				<div class="row center-align">
					...
					<div class="row">
						<div class="col s12">
							<p class="center-align"><b>Zona:</b> Oro | <b>Función:</b> 16hrs.</p>
						</div>
					</div>
					...
					{!! Form::hidden('db_table', 'aventuras_de_zamora_21mar16') !!}
					{!! Form::hidden('info', '') !!}
					{!! Form::hidden('precio', 170) !!}
					{!! Form::hidden('url', url('eventos/las-aventuras-de-16hrs')) !!}
