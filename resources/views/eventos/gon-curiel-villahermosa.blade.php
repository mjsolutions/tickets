...
@section('title', 'Gon Curiel Villahermosa')

@section('description', 'Gon Curiel en Villahermosa, 27 de septiembre, 19:00 hrs boletos en La Puerta de Alcala')
...
<div class="image-header bg-4 overlay overlay-5">
	...
	<div class="row white-text">
		...
		<p><i>Villahermosa La Puerta de Alcala</i></p>
	</div>
	...
	<div class="row">
		...
		<div id="descripcion" class="col s12 tab-content">
			...
			<div class="col s8 offset-s2 m3 mb-30 card-flyer">
				<img src="{{ asset('img/gon-villahermosa.jpg') }}" alt="" class="responsive-img">
			</div>
			...
			<div class="col s12 m8 offset-m1">				
				...
				<div class="row">
					...
					{{-- <p class="center-align"><b>Reservaciones:</b> <a href="tel:4442041482" style="background: #4caf50; color: #fff; padding: 5px 10px;">444 204 1482</a> --}}
				</div>
			</div>
		</div>
...
<section id="compra" class="section-comprar">
	...
	<div class="row">
		<div class="col m4 offset-m4">
			<h5 class="mt-50 center-align raleway">Venta de boletos en el lugar del evento</h5>
			<div class="row">
