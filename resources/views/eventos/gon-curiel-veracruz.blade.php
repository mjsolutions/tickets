...
@section('title', 'Gon Curiel Veracruz')

@section('description', 'Gon Curiel en Veracruz, 28 de septiembre, 19:00 hrs boletos en Barezzito')
	...
	<div class="row">
		...
		<div id="descripcion" class="col s12 tab-content">
			...
			<div class="col s8 offset-s2 m3 mb-30 card-flyer">
				<img src="{{ asset('img/gon-veracruz.jpg') }}" alt="" class="responsive-img">
			</div>
