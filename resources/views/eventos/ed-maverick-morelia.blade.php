...
@section('title', 'Ed Maverick - Morelia')

@section('description', 'Ed Maverick en Morelia, Salón Arena, 28 de noviembre, 21:00 hrs boletos en Taquillas de Salón Arena y bolematico.com')

@section('styles')
<meta property="og:url"  content="https://www.bolematico.com/eventos/ed-maverick-morelia" />
<meta property="og:title" content="Ed Maverick en Morelia" />
<meta property="og:description" content="Ed Maverick en Morelia, Salón Arena, 28 de noviembre, 21:00 hrs boletos en Taquillas de Salón Arena y bolematico.com" />
<meta property="og:image" content="https://www.bolematico.com/img/ed-maverick-morelia.jpg" />
...
<div class="image-header bg-4 overlay overlay-5">
	...
	<div class="row white-text">
		...
		<p class="mb-0"><i>Salón Arena - Morelia</i></p>
	...
	<div class="row">
		...
		<div id="precios" class="col s12 tab-content" style="padding: 40px 0.75rem!important;">
			...
			<div class="col s8 offset-s2 m4 offset-m1 mb-30 card-flyer">
				<img src="{{ asset('img/ed-maverick-morelia.jpg') }}" alt="" class="responsive-img">
			</div>
			...
			<div class="col s12 m5 offset-m2">		
				...
				<div class="row center-align">
					...
					{!! Form::hidden('img', 'img/ed-maverick-morelia.jpg') !!}
					{!! Form::hidden('evento', 'Ed Maverick') !!}
					{!! Form::hidden('fecha', '28 de noviembre 2020') !!}
					{!! Form::hidden('lugar', 'Salón Arena') !!}
					{!! Form::hidden('ciudad', 'Morelia, Mich.') !!}
					{!! Form::hidden('hora', '21:00 hrs') !!}
					{!! Form::hidden('event_type', 'general') !!}
					{!! Form::hidden('impresion_boleto', true) !!}
					{!! Form::hidden('db_table', 'ed_maverick_morelia_30may') !!}
					{!! Form::hidden('info', '') !!}
					{!! Form::hidden('precio', '', ['id' => 'form_precio']) !!}
					{!! Form::hidden('url', url('eventos/ed-maverick-morelia')) !!}
...
<section class="section-lugar">
	<div class="row">
		<div class="col m9">
			<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15024.651786822731!2d-101.1972774!3d19.7056856!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xaae720771819e54c!2sSal%C3%B3n%20Arena!5e0!3m2!1ses!2smx!4v1580646460868!5m2!1ses!2smx" width="100%" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
		</div>
		<div class="col m3">
			<h5 class="quote raleway">Lugar del evento</h5>
			
			<h5 class="mt-30">Salón Arena</h5>
			<div class="col s10">
				<div class="divider"></div>
			</div>
			<ul class="fa-ul" style="margin-top: 30px;">
				<li class="mb-10"><i class="fa-li fa fa-map-marker"></i> Calle de Eduardo Ruiz 612, <br>Centro histórico de Morelia, 58000 <br>Morelia, Mich.</li>
...
@section('scripts')
	<script>
		var precios = {'Oro': 580, 'General': 430};
