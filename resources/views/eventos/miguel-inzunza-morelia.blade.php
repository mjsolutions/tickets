...
@section('description', 'Miguel Inzunza en Morelia, Café del Olmo, 15 de febrero, 20:30 hrs boletos en RS Viajes Centro y bolematico.com')
...
<meta property="og:description" content="Miguel Inzunza en Morelia, Café del Olmo, 15 de febrero, 20:30 hrs boletos en RS Viajes Centro y bolematico.com" />
...
@php
	$preventa = false;
	if(\Carbon\Carbon::now() < '2020-02-09 23:59:59'){
		$preventa = true;
	}
@endphp
...
<div class="image-header bg-del-olmo overlay overlay-5">
	...
	<div class="row white-text">
		...
		<p class="m-0"><i>15 de febrero - 20:30 hrs.</i></p>
	</div>
		...
		<div id="precios" class="col s12 tab-content" style="padding: 40px 0.75rem!important;">
			...
			<div class="col s12 m5 offset-m2">				
				...
				<div class="row center-align">
					...
					{!! Form::hidden('fecha', '15 de febrero 2020') !!}
					...
					{!! Form::hidden('db_table', 'miguel_inzunza_morelia_15feb') !!}
...
<section class="section-video overlay overlay-5" style="background-image: url('https://img.youtube.com/vi/uE9tir1KLvQ/maxresdefault.jpg');">
	<div class="row center-align">
		<a class="white-text" id="modal-video-open" href="#modal-video" data-video="https://www.youtube.com/embed/uE9tir1KLvQ"><i class="material-icons">play_circle_filled</i></a>
		<p class="white-text"><i>La Nieta Del Navegante, Sesión Acústica</i></p>
	</div>
</section>
