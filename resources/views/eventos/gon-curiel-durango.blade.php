...
@section('title', 'Gon Curiel Durango')

@section('description', 'Gon Curiel en Durango, 01 de marzo 2019, 21:00 hrs preventa $280, evento $310')
	...
	<div class="row">
		...
		<div id="descripcion" class="col s12 tab-content">
			...
			<div class="col s8 offset-s2 m4 offset-m1 mb-30">
				<img src="{{ asset('img/gon-durango.jpg') }}" alt="" class="responsive-img">
			</div>
		...
		<div id="lugares" class="col s12 tab-content">
			...
			<div class="col s12">									
				...
				<div class="white z-depth-2">
					<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d10307.676788439014!2d-104.68782131818128!3d24.019987218906376!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x4fb09f15eca7d57b!2sLa+Quinta+del+Mal!5e0!3m2!1ses!2smx!4v1548114252238" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
				
				<!-- ## ADDRESS LIST ## -->
					<div class=" p-30">
						<h5 class="raleway"><b>La Quinta</b></h5>
						<ul class="qcAddress">
							<li><div class="divider"></div></li>
							<li><i class="fa fa-map-marker"></i> <p>Vista Hermosa del Guadiana, 34116 Durango, Dgo.</p></li>
							<li><i class="fa fa-phone"></i><p> 618 130 0712</p></li>
							<li><i class="fa fa-facebook-official"></i><p><a title="website" href="https://www.facebook.com/LaQuintaDelMalDgo/" target="_blank">https://www.facebook.com/LaQuintaDelMalDgo/</a></p></li>
						</ul>
					</div>
				</div>
...
<section id="compra" class="section-comprar">
	...
	<div class="row mb-30">
		...
		<div class="col s12 m4 offset-m4">
			...
			{!! Form::hidden('img', 'img/gon-durango.png') !!}
			{!! Form::hidden('evento', 'Gon Curiel') !!}
			{!! Form::hidden('fecha', '01 de marzo 2019') !!}
			{!! Form::hidden('lugar', 'La Quinta') !!}
			{!! Form::hidden('ciudad', 'Durango') !!}
...
<section class="section-lugar">
	...
	<div class="info-lugar">
		...
		<p><b>La Quinta</b></p>
		<p><i class="material-icons">location_on</i>Vista Hermosa del Guadiana, 34116 Durango, Dgo.</p>
		<p><i class="material-icons">call</i> 618 130 0712</p>
		<p><i class="fa fa-facebook-official"></i> https://www.facebook.com/LaQuintaDelMalDgo/</p>
	</div>
</section>
...
@section('scripts')
	<script>
		...
		function initMap() {
		        var uluru = {lat: 24.0203682, lng: -104.6897093};
		        var map = new google.maps.Map(document.getElementById('map'), {
		          zoom: 16,
		          scrollwheel: false,
		          navigationControl: true,
		          draggable: true,
		          center: {lat: 24.0203682, lng: -104.6882093}
		        });
