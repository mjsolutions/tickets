...
@section('title', 'Luiki Wiki & Pachis Xalapa')

@section('description', 'Luiki Wiki & Pachis en Xalapa, 01 de Febrero, 9 pm boletos en Barezzito y en bolematico.mx')
...
<div class="image-header bg-4 overlay overlay-5">
	...
	<div class="row white-text">
		...
		<p><i>Xalapa - Barezzito Xalapa</i></p>
	</div>
		...
		<div id="descripcion" class="col s12 tab-content">
			...
			<div class="col s12 m8 offset-m1">				
				...
				<div class="row">
					...
					<p class="center-align"><b>Informes:</b> <a href="tel:2288129099" style="background: #4caf50; color: #fff; padding: 5px 10px;">228 812 9099</a></p>
				</div>
			</div>
		</div>
