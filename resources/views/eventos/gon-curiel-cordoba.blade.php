...
@section('title', 'Gon Curiel Cordoba')

@section('description', 'Gon Curiel en Cordoba, 15 de Febrero, 9 pm boletos en Sabina y en bolematico.mx')
	...
	<div class="row">
		...
		<div id="descripcion" class="col s12 tab-content">
			...
			<div class="col s8 offset-s2 m3 mb-30 card-flyer">
				<img src="{{ asset('img/gon-15.jpeg') }}" alt="" class="responsive-img">
			</div>
			...
			<div class="col s12 m8 offset-m1">				
				...
				<div class="row">
					...
					<p class="center-align"><b>Informes:</b> <a href="tel:2717105159" style="background: #4caf50; color: #fff; padding: 5px 10px;">271 710 5159</a></div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col s12 m6">									
					...
					<div class="qcEventlayout">
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d120793.68154542464!2d-97.0064483600957!3d18.89583878317047!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85c4e5697b20749f%3A0x2982c742ee38da54!2sSabina+Live+Bar!5e0!3m2!1ses!2smx!4v1517117568842" width="100%" height="320" frameborder="0" style="border:0" allowfullscreen></iframe>
					</div>
				</div>
				...
				<div class="col s12 m6">
					<ul class="qcAddress">
						...
						<li><i class="medium material-icons">call</i><p><strong>TELÉFONO</strong>: 271 710 5159<</p></li>
...
<section id="compra" class="section-comprar">
	...
	<div class="row">
		<div class="col m4 offset-m4">
			<h5 class="mt-50 center-align raleway">Venta de boletos en Sabina Cordoba</h5>
			<div class="row">
...
<section class="section-lugar">
	...
	<div class="info-lugar">
		...
		<p><b>Sabina Cordoba</b></p>
		<p><i class="material-icons">location_on</i>Av 1 410d, Centro, 94500 Córdoba, Ver.</p>
		<p><i class="material-icons">call</i> 271 710 5159<</p>
		<p>{{-- <i class="material-icons">language</i> --}}https://www.facebook.com/sabinalivebar/</p>
	</div>
</section>
...
@section('scripts')
	<script>
		...
		function initMap() {
		        var uluru = {lat: 18.8958506, lng: -96.9364088};
		        var map = new google.maps.Map(document.getElementById('map'), {
		          zoom: 16,
		          scrollwheel: false,
		          navigationControl: true,
		          draggable: true,
		          center: {lat: 18.8958506, lng: -96.9358788}
		        });
