...
@section('title', 'Santiago Cruz León')

@section('description', 'Santiago Cruz en León, 07 de Junio, 9:00 pm boletos en Maybach')
...
<div class="image-header bg-4 overlay overlay-5">
	...
	<div class="row white-text">
		...
		<p><i>León - Maybach Concert Hall</i></p>
	</div>
	...
	<div class="row">
		...
		<div id="descripcion" class="col s12 tab-content">
			...
			<div class="col s8 offset-s2 m3 mb-30">
				<img src="{{ asset('img/santiago-leon.jpg') }}" alt="Santiago Cruz León" class="responsive-img">
			</div>
			...
			<div class="col s12 m8 offset-m1">				
				...
				<div class="row mt-30">
					...
					<div class="qcPricing col s12 center-align mb-10">
						<div class="box col s12">
							<header>
								<div class="col s12 m12 teal accent-4">Zona diamante</div>
								{{-- <div class="col m4 btn-buy nopadding hide-on-small-only"><a href="#compra" class="page-scroll"><b>Comprar</b></a></div> --}}
							</header>
							<div class="price col s12"><span>$800</span> Por entrada</div>
							{{-- <div class="filas col s6">Filas: Y - Z</div> --}}
							{{-- <div class="col s12 btn-buy nopadding hide-on-med-and-up"><a href="#compra" class="page-scroll"><b>Comprar</b></a></div> --}}
						</div>
					</div>
				...
				<div class="row">
					<div class="divider"></div>
					<p class="center-align mt-30">Venta de boletos en el lugar del evento</p>
				</div>
			</div>
		</div>
		...
		<div id="lugares" class="col s12 tab-content">
			...
			<div class="row">
				<div class="col s12">
					<h5>Maybach Concert Hall</h5>
				</div>
				<div class="col s12 m6">									
					<!-- ## VENUE MAP ## -->
					<div class="qcEventlayout">
						<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14884.444879903624!2d-101.6765366!3d21.1479717!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x8a1e2d2d5be32d2c!2sMaybach+Concert+Hall!5e0!3m2!1ses!2smx!4v1494358923820" width="100%" height="320" frameborder="0" style="border:0" allowfullscreen></iframe>
					</div>
				...
				<div class="col s12 m6">
					<ul class="qcAddress">
						<li><i class="medium material-icons">location_on</i><p><strong>DIRECCIÓN</strong>: Blvd. Campestre 42, Fraccionamiento de los Gomez Predio, León, Gto.</p></li>
						<li><i class="medium material-icons">schedule</i><p><strong>HORARIO</strong>: Miercoles a Sábado de 6pm a 10pm</p></li>
						<li><i class="medium material-icons">call</i><p><strong>TELÉFONO</strong>: 477 396 4410</p></li>
						<li><i class="medium material-icons">language</i><p><strong>Website</strong>: <a title="website" href="https://www.facebook.com/maybachconcerthall/" target="_blank">https://www.facebook.com/maybachconcerthall</a></p></li>
					</ul>
				</div>
			</div>
...
<section class="section-comprar">
	<h5 class="mt-50 center-align raleway">Venta de boletos exlusivamente en Maybach Concert Hall</h5>
	<div class="row">
...
<section class="section-lugar">
	...
	<div class="info-lugar">
		...
		<p><b>Maybach Concert Hall</b></p>
		<p><i class="material-icons">location_on</i> Blvd. Campestre 42, Fraccionamiento de los Gomez Predio, León, Gto.</p>
		<p><i class="material-icons">schedule</i><strong>HORARIO</strong>: Miercoles a Sábado de 6pm a 10pm</p>
		<p><i class="material-icons">call</i> 477 396 4410</p>
		<p><i class="material-icons">language</i> <a title="website" href="https://www.facebook.com/maybachconcerthall" target="_blank">fb/maybachconcerthall</a></p>
	</div>
</section>
...
@section('scripts')
	<script>
		...
		function initMap() {
		        var uluru = {lat: 21.1479717, lng: -101.6765366};
		        var map = new google.maps.Map(document.getElementById('map'), {
		          zoom: 18,
		          scrollwheel: false,
		          navigationControl: true,
		          draggable: true,
		          center: {lat: 21.1479717, lng: -101.6758366}
		        });
