...
@section('title', 'Alan Saldaña Villahermosa')

@section('description', 'Alan Saldaña en Villahermosa, 15 de Marzo, 10 pm boletos en La Puerta de Alcalá y en bolematico.mx')
	...
	<div class="row">
		...
		<div id="descripcion" class="col s12 tab-content">
			...
			<div class="col s8 offset-s2 m3 mb-30 card-flyer">
				<img src="{{ asset('img/alan_villahermosa.jpg') }}" alt="" class="responsive-img">
			</div>
			...
			<div class="col s12 m8 offset-m1">				
				...
				<div class="row">
					...
					<p class="center-align"><b>Informes y Reservaciones:</b> <a href="tel:9931298575" style="background: #4caf50; color: #fff; padding: 5px 10px;">993 129 8575</a></p>
				</div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col s12 m6">									
					...
					<div class="qcEventlayout">
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5366.395683921486!2d-92.94666431070313!3d17.996650669141108!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85edd7894feb2e89%3A0x11300dce777346a7!2sLa+Puerta+de+Alcal%C3%A1+Villa!5e0!3m2!1ses!2smx!4v1520412128818" width="100%" height="320" frameborder="0" style="border:0" allowfullscreen></iframe>
					</div>
				</div>
				...
				<div class="col s12 m6">
					<ul class="qcAddress">
						...
						<li><i class="medium material-icons">language</i><p><strong>Website</strong>: <a title="website" href="https://www.facebook.com/lapuertadealcalavhsa/" target="_blank">https://www.facebook.com/lapuertadealcalavhsa/</a></p></li>
					</ul>
				</div>
			</div>			
...
<section id="compra" class="section-comprar">
	...
	<div class="row">
		<div class="col m4 offset-m4 mt-30">
			<h5 class="center-align raleway">Venta de boletos en La Puerta de Alcalá Villahermosa</h5>
		</div>
			...
			@if(Auth()->check())
				{!! Form::open(['route'=>'payment.details', 'method'=>'POST']) !!}
					<div class="row">
						...
						{!! Form::hidden('evento', 'Alan Saldaña en Villahermosa') !!}
						{!! Form::hidden('fecha', '15 de Marzo 2018') !!}
						{!! Form::hidden('lugar', 'La Puerta de Alcalá, Villahermosa') !!}
...
<section class="section-lugar">
	...
	<div class="info-lugar">
		...
		<p><b>La Puerta de Alcalá Villahermosa</b></p>
		...
		<p><i class="material-icons">language</i>https://www.facebook.com/lapuertadealcalavhsa/</p>
	</div>
</section>
...
@section('scripts')
	<script>
		...
		function initMap() {
		        var uluru = {lat: 17.9952325, lng: -92.9418827};
		        var map = new google.maps.Map(document.getElementById('map'), {
		          zoom: 16,
		          scrollwheel: false,
		          navigationControl: true,
		          draggable: true,
		          center: {lat: 17.9952325, lng: -92.9411827}
		        });
