...
@section('title', 'Geassassin - Patzcuaro')

@section('description', 'Geassassin en Patzcuaro, Salón los Olivos, 16 de octubre, 19:00 hrs boletos en bolematico.com')

@section('styles')
<meta property="og:url"  content="https://www.bolematico.com/eventos/geassassin-patzcuaro" />
<meta property="og:title" content="Geassassin en Patzcuaro" />
<meta property="og:description" content="Geassassin en Patzcuaro, Salón los Olivos, 16 de octubre, 19:00 hrs boletos en bolematico.com" />
<meta property="og:image" content="https://www.bolematico.com/img/geassassin_patz.jpg" />
...
<div class="image-header bg-4 overlay overlay-5">
	...
	<div class="row white-text">
		...
		<p class="mb-0"><i>Salón los Olivos - Patzcuaro</i></p>
		<p class="m-0"><i>16 de octubre - 19:00 hrs.</i></p>
	</div>
	...
	<div class="row">
		...
		<div id="precios" class="col s12 tab-content" style="padding: 40px 0.75rem!important;">
			...
			<div class="col s8 offset-s2 m4 offset-m1 mb-30 card-flyer">
				<img src="{{ asset('img/geassassin_patz.jpg') }}" alt="" class="responsive-img">
			</div>
			...
			<div class="col s12 m5 offset-m2">		
				...
				<div class="row">
					<div class="qcPricing col s12 center-align mb-10">
						<div class="box col s12">
							<header>
								<div class="col s12 purple darken-1">Superfan</div>
							</header>
							<div class="price col s12"><span>$2,650</span> MXN</div>
						</div>
					</div>
					...
					<div class="qcPricing col s12 center-align mb-10">
						<div class="box col s12">
							<header>
								<div class="col s12 teal accent-4">Meet&Greet</div>
							</header>
					...
					<div class="qcPricing col s12 center-align mb-10">
						<div class="box col s12">
							...
							<div class="price col s12"><span>$180</span> MXN</div>
						</div>
					</div>
				...
				<div class="row center-align">
					...
					<div class="row">
						...
						<div class="col m4">
							<div class="col m12 zona-radio">
								{!! Form::radio('zona', 'M&G', false, ['id' => 'M&G', 'class' => 'form_zona']) !!}
								{!! Form::label('M&G', 'Meet&Greet') !!}
							</div>
						</div>
						<div class="col m4">
							<div class="col m12 zona-radio">
					...
					{!! Form::hidden('img', 'img/geassassin_patz.jpg') !!}
					{!! Form::hidden('evento', 'Geassassin') !!}
					{!! Form::hidden('fecha', '16 de octubre 2020') !!}
					{!! Form::hidden('lugar', 'Salón los Olivos') !!}
					{!! Form::hidden('ciudad', 'Patzcuaro, Mich.') !!}
					{!! Form::hidden('hora', '19:00 hrs') !!}
					{!! Form::hidden('event_type', 'general') !!}
					{!! Form::hidden('impresion_boleto', true) !!}
					{!! Form::hidden('db_table', 'geassassin_patz_16oct') !!}
					{!! Form::hidden('info', '') !!}
					{!! Form::hidden('precio', '', ['id' => 'form_precio']) !!}
					{!! Form::hidden('url', url('eventos/geassassin-patzcuaro')) !!}
		...
		{{-- <div id="lugares" class="col s12 tab-content">
				...
				<div class="white z-depth-2">
					...
					<div class=" p-30">
						...
						<ul class="qcAddress">
							...
							<li><i class="fa fa-map-marker"></i> <strong>DIRECCIÓN</strong>: <p>Calle de Eduardo Ruiz 620, Centro histórico de Patzcuaro, 58000 Patzcuaro, Mich.</p></li>
						</ul>
					</div>
				</div>
			...
			<div class="col s4">									
				<div class="white z-depth-2">
					...
					<div class=" p-30">
						...
						<ul class="qcAddress">
							<li><div class="divider"></div></li>
							<li><i class="fa fa-map-marker"></i> <strong>DIRECCIÓN</strong>: <p>20 de Noviembre 917, Centro Histórico, 58000 Patzcuaro, Mich.</p></li>
			...
			<div class="col s4">									
				<div class="white z-depth-2">
					...
					<div class=" p-30">
						<h5><b>Salón los Olivos</b></h5>
						<ul class="qcAddress">
							<li><div class="divider"></div></li>
							<li><i class="fa fa-map-marker"></i> <strong>DIRECCIÓN</strong>: <p>Libramiento Oriente 3118, Jardines del Rincón, 58270 Patzcuaro, Mich.</p></li>
						</ul>
					</div>
				</div>
...
<section class="section-video overlay overlay-5" style="background-image: url('https://img.youtube.com/vi/aIvF7kD_GuY/maxresdefault.jpg');">
	<div class="row center-align">
		<a class="white-text" id="modal-video-open" href="#modal-video" data-video="https://www.youtube.com/embed/aIvF7kD_GuY"><i class="material-icons">play_circle_filled</i></a>
		<p class="white-text"><i>99's</i></p>
	</div>
</section>

<section id="compra" class="section-comprar">
	<div class="row">
		{{-- <h5 class="raleway center-align">Venta de boletos también en Taquillas de Salón los Olivos</h5> --}}
...
<section class="section-lugar">
	<div class="row">
		<div class="col m9">
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3759.977278146787!2d-101.61778464906185!3d19.542589042152624!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x842d97a27f94f1d3%3A0x2ea8aaae1b476e5!2zU2Fsw7NuIC0gSmFyZMOtbiAtIENhYmHDsWEgIkxvcyBPbGl2b3Mi!5e0!3m2!1ses!2smx!4v1593400746004!5m2!1ses!2smx" width="100%" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
		</div>
		<div class="col m3">
			<h5 class="quote raleway">Lugar del evento</h5>
			
			<h5 class="mt-30">Salón los Olivos</h5>
			<div class="col s10">
				<div class="divider"></div>
			</div>
			<ul class="fa-ul" style="margin-top: 30px;">
				<li class="mb-10"><i class="fa-li fa fa-map-marker"></i>Calzontzin, Esquina Purepero, Estacionamiento 2, <br>Muelle general <br>Patzcuaro, Mich.</li>
			</ul>
...
@section('scripts')
	<script>
		var precios = {'Superfan': 2650, 'M&G': 280, 'General': 180};
