...
@section('description', 'Fernando Delgadillo en Córdoba, 21 de diciembre, 21:00 hrs boletos en Sabina Live Bar y bolematico.com')
...
<meta property="og:description" content="Fernando Delgadillo en Córdoba, 21 de diciembre, 21:00 hrs boletos en Sabina Live Bar y bolematico.com" />
...
@php
	...
	$preventa = false;
	if(\Carbon\Carbon::now() < '2019-10-31 23:59:59'){
		$preventa = true;
	}
@endphp
...
<div class="image-header bg-4 overlay overlay-5">
	...
	<div class="row white-text">
		...
		<p class="m-0"><i>21 de diciembre - 21:00 hrs.</i></p>
	</div>
		...
		<div id="precios" class="col s12 tab-content">
			...
			<div class="col s12 offset-m1 m5">
				...
				<div class="row">
					<div class=" qcPricing col s12 mb-15">
						<h5 class="quote raleway">Precios de preventa, despues un poco más.</h5>
					</div>
			...
			<div class="row">
				...
				<div class="col s10 offset-s1 center-align">
					...
					<p><i>* Preventa válida hasta el 31 de octubre del 2019.</i></p>
					<p>* Informes al:</p>
