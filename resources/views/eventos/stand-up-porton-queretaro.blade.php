...
@section('title', 'Stand Up - Querétaro')

@section('description', 'Stand Up en Querétaro, El Portón de Santiago, 12 de marzo, 21:00 hrs boletos en El Portón de Santiago y bolematico.com')

@section('styles')
<meta property="og:url"  content="https://www.bolematico.com/eventos/stand-up-porton-queretaro" />
<meta property="og:title" content="Stand Up en Querétaro" />
<meta property="og:description" content="Stand Up en Querétaro, El Portón de Santiago, 12 de marzo, 21:00 hrs boletos en El Portón de Santiago y bolematico.com" />
<meta property="og:image" content="https://www.bolematico.com/img/stand-up-porton.jpg" />
...
@php
	$preventa = false;
	if(\Carbon\Carbon::now() < '2020-03-11 23:59:59'){
		$preventa = true;
	}
@endphp
...
<div class="image-header bg-del-olmo overlay overlay-5">
	...
	<div class="row white-text">
		<h4>Stand Up <br><small>(Güero Cocom, Marco Guevara, Solín)</small></h4>
	...
	<div class="row">
		...
		<div id="precios" class="col s12 tab-content" style="padding: 40px 0.75rem!important;">
			...
			<div class="col s8 offset-s2 m4 offset-m1 mb-30 card-flyer">
				<img src="{{ asset('img/stand-up-porton.jpg') }}" alt="" class="responsive-img">
			</div>
			...
			<div class="col s12 m5 offset-m2">				
				...
				<div class="row center-align">
					...
					{!! Form::hidden('img', 'img/stand-up-porton.jpg') !!}
					{!! Form::hidden('evento', 'Stand Up') !!}
					{!! Form::hidden('fecha', '12 de marzo 2020') !!}
					...
					{!! Form::hidden('db_table', 'stand_up_porton_12mar') !!}
					...
					@endif
					{!! Form::hidden('url', url('eventos/stand-up-porton-queretaro')) !!}
          ...
          <p> * Informes y confirmación de tu reservación (una vez realizada tu compra) <br> <a href="tel:4427400671" style="background: #4caf50; color: #fff; padding: 5px 10px;">442-740-0671</a> / <a href="tel:4426889491" style="background: #4caf50; color: #fff; padding: 5px 10px;">442-688-9491</a></p>
...
<section class="section-video overlay overlay-5" style="background-image: url('https://img.youtube.com/vi/SBmY8GgF46c/hqdefault.jpg');">
	<div class="row center-align">
		<a class="white-text" id="modal-video-open" href="#modal-video" data-video="https://www.youtube.com/embed/SBmY8GgF46c"><i class="material-icons">play_circle_filled</i></a>
		<p class="white-text"><i>El Güero Cocom Stand Up - Lobo de Wall Street</i></p>
	</div>
</section>
