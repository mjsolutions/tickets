...
<div class="navbar-fixed">
  <nav class="transparent-header">
    <div class="nav-wrapper">
      <div class="container">
        <a href="" class="brand-logo mt-5"><img class="responsive-img" width="150px" style="height:90px;" src="{{asset('images/Logo_Negro.svg')}}"></a>
      ...
      <ul class="center-align side-nav" id="mobile-demo">
        <div class="row mb-0">
          <div class="col s10 col-center mt-30">
            <a href="">
              <img class="responsive-img" src="{{asset('images/Logo_Negro.svg')}}">
            </a>
          </div>
        </div>
        <div class="row">
