...
<div class="navbar-fixed">
  <nav class="transparent-header">
    <div class="nav-wrapper">
      <div class="container">
        <a href="{{ route('bolematico.inicio') }}" class="brand-logo mt-5 page-scroll"><img class="responsive-img" width="150px" style="height:90px;" src="{{asset('img/logotipo-negro-tipo2.svg')}}"></a>
        <a href="#" data-activates="mobile-demo" class="button-collapse"><i class="material-icons">menu</i></a>
        <ul class="right hide-on-med-and-down">
        <li><a class="menu page-scroll" href="{{ route('bolematico.inicio') }}">Eventos</a></li>
